...
<div id="otkr_lp" class="">
  ...
  <header id="otkr-header" class="otkr-header">
    ...
    <div class="otkr-header--covid">
      <a class="otkr-pc" href="https://www.otakaraya.jp/lp_page/corona/"><p><?php the_field('header_link_text'); ?></p></a>
      <a class="otkr-sp" href="https://www.otakaraya.jp/lp_page/corona/"><p><?php the_field('header_link_text'); ?></p></a>
    </div>
