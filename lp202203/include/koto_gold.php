...
<div class="box01 boxeffect"></div>
  ...
  <div class="otkr-cmn-inner">
    ...
    <?php
    $price_highest_img_option_use = get_field('price_highest_img_option_use','option');
    $price_highest_gap_use = get_field('price_highest_gap_use','option');

    if($price_highest_img_option_use):
    
    ?>
    <div class="banner" data-option="share">
      <img src="<?php echo get_field('price_highest_img','option')['url']; ?>" alt="<?php echo $alt_add_word;?> <?php the_field('price_highest_img_text'); ?>" class="otkr-pc">
      <img src="<?php echo get_field('price_highest_img_sp','option')['url']; ?>" alt="<?php echo $alt_add_word;?> <?php the_field('price_highest_img_text'); ?>" class="otkr-sp">
    </div>

    <?php else: ?>
      <div class="banner" data-option="single">
              ...
              <table class="rate-table table_gold">
                <tbody>
                  <tr>
                    ...
                    <td class="up"><div><span>UP! &gt;</span><strong>{{price_add(au_scrap[0].price,<?php the_field('price_highest_upprice');?>)}}<small>円</small></strong></div></td>
                  </tr>
                  <tr>
                    <th>K22</th>
                    <td>{{au_scrap[1].price}}円</td>
                    <td class="up"><div><span>UP! &gt;</span><strong>{{price_add(au_scrap[1].price,<?php the_field('price_highest_upprice');?>)}}<small>円</small></strong></div></td>
                  </tr>
                  <tr>
                    <th>K21.6</th>
                    <td>{{au_scrap[2].price}}円</td>
                    <td class="up"><div><span>UP! &gt;</span><strong>{{price_add(au_scrap[2].price,<?php the_field('price_highest_upprice');?>)}}<small>円</small></strong></div></td>
                  </tr>
                  <tr>
                    <th>K20</th>
                    <td>{{au_scrap[3].price}}円</td>
                    <td class="up"><div><span>UP! &gt;</span><strong>{{price_add(au_scrap[3].price,<?php the_field('price_highest_upprice');?>)}}<small>円</small></strong></div></td>
                  </tr>
                  <tr>
                    <th>K18</th>
                    <td>{{au_scrap[4].price}}円</td>
                    <td class="up"><div><span>UP! &gt;</span><strong>{{price_add(au_scrap[4].price,<?php the_field('price_highest_upprice');?>)}}<small>円</small></strong></div></td>
                  </tr>
                </tbody>
              ...
              <table class="rate-table table_gold">
                <tbody>
                  <tr>
                    ...
                    <td class="up"><div><span>UP! &gt;</span><strong>{{price_add(au_scrap[5].price,<?php the_field('price_highest_upprice');?>)}}<small>円</small></strong></div></td>
                  </tr>
                  <tr>
                    <th>K10</th>
                    <td>{{au_scrap[6].price}}円</td>
                    <td class="up"><div><span>UP! &gt;</span><strong>{{price_add(au_scrap[6].price,<?php the_field('price_highest_upprice');?>)}}<small>円</small></strong></div></td>
                  </tr>
                  <tr>
                    <th>K9</th>
                    <td>{{au_scrap[7].price}}円</td>
                    <td class="up"><div><span>UP! &gt;</span><strong>{{price_add(au_scrap[7].price,<?php the_field('price_highest_upprice');?>)}}<small>円</small></strong></div></td>
                  </tr>
                  <tr>
                    <th>K18WG</th>
                    <td>{{au_scrap[8].price}}円</td>
                    <td class="up"><div><span>UP! &gt;</span><strong>{{price_add(au_scrap[8].price,<?php the_field('price_highest_upprice');?>)}}<small>円</small></strong></div></td>
                  </tr>
                  <tr>
                    <th>K14WG</th>
                    <td>{{au_scrap[9].price}}円</td>
                    <td class="up"><div><span>UP! &gt;</span><strong>{{price_add(au_scrap[9].price,<?php the_field('price_highest_upprice');?>)}}<small>円</small></strong></div></td>
                  </tr>
                </tbody>
