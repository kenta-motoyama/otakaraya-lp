...
<section class="otkr-another-lp otkr-animation">
  ...
  <div class="otkr-cmn-inner fadein">
    <div class="otkr-ttl">
      <h2><?php the_field('another_lp2_title'); ?></h2>
      <p><?php the_field('another_lp2_sub'); ?></p>
    </div>
    <?php if(have_rows('another_lp2_detail')): ?>
    <div class="otkr-another-lp-wrap">
    <?php while(have_rows('another_lp2_detail')): the_row(); ?>
    <div class="block">
      <figure>
