<?php
/*
Template Name: LP Type 4　（ブランド用）
*/
// ini_set('display_errors', "On");
$pagetype = 4;
$alt_add_word = get_field('alt_add_word');
...
?>
  ...
  <main class="otkr-content" data-pagetype="<?php echo $pagetype;?>">
    <article class="otkr-wrap">

          <div class="otkr-kv" style="background-image: url(<?php the_field('mv_bg'); ?>);">
            <div class="otkr-cmn-inner">
              <img src="<?php the_field('mv'); ?>" alt="<?php echo $alt_add_word;?> 高価買取" class="otkr-pc">
              <img src="<?php the_field('mv_sp'); ?>" alt="<?php echo $alt_add_word;?> 高価買取" class="otkr-sp">
            </div>
          </div>
          <?php 
