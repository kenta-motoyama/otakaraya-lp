...
*/
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/lp-type7.css" />
...
<body data-category="<?php echo $cp_category; ?>" data-pagetype="<?php echo $pagetype; ?>">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-W2M2WF" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        ...
        <header id="otkr-header" class="otkr-header">
            <?php if ($pagetype != 2) : ?>
                <div class="otkr-header--covid">
                    <a class="otkr-pc" href="https://www.otakaraya.jp/lp_page/corona/">
                        <p>コロナ対策徹底、定期的にPCR検査済み</p>
                    </a>
                    <a class="otkr-sp" href="https://www.otakaraya.jp/lp_page/corona/">
                        <p>コロナ対策徹底、定期的にPCR検査済み</p>
                    </a>
                </div>
            <?php endif; ?>
                ...
                <div class="otkr-header--content">
                    ...
                    <div class="otkr-header--tel">
                        ...
                        <div class="tel_link">
                            ...
                            <p class="tel_linkText"><a href="<?php echo $contacturl; ?>"><?php the_field('common_tel_contact'); ?></a></p>
                        </div>
